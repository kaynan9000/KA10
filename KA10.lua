-- [[ KA HUB | ULTIMATE V8 REBORN - ESP FIX EDITION ]]
...
local Window = Rayfield:CreateWindow({
   ...
   LoadingSubtitle = "AutoClick + Combat + Fly + Jump",
...
RunService.RenderStepped:Connect(function()
    ...
    -- Lógica de ESP (Atualização contínua)
    if Config.ESP then
        for _, p in pairs(Players:GetPlayers()) do
...
Rayfield:Notify({Title = "KA HUB ATUALIZADO", Content = "ESP Corrigido!", Duration = 5})
